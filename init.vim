...
nnoremap <leader>gff <cmd>Telescope git_files<cr>
nnoremap <leader>gst <cmd>Telescope git_status<cr>

"---- Conjure testing custom 
nnoremap <localleader>tt :ConjureCljRunCurrentTest<CR>
nnoremap <localleader>tn :ConjureCljCurrentNsTests<CR>
nnoremap <localleader>ta :ConjureCljRunAllTests<CR>
